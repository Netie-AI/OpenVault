...
r.get("/browse", { tag: "settings:read", authorizationHandledByOperation: true, mcp: { description: "Browse source directories on this FreeBuild controller, not the MCP client. Requires instance administrator authority; use folder upload for a client-side directory." }, query: BrowseDirectoriesInputSchema }, fs.browse);
