...
r.get("/status", { tag: "cloud:read", mcp: { description: "The hosted cloud service's connection status for this instance." } }, local.status);

r.get("/workspaces", { tag: "cloud:read", mcp: { description: "List the org's workspaces on the hosted cloud service." } }, local.listWorkspaces);
