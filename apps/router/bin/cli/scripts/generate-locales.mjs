...
const TRANSLATIONS = {
  ar: {
    common: {
      error: "خطأ: {message}",
      serverOffline: "خادم FreeRoute غير متصل. ابدأ بالأمر: freeroute serve",
      authRequired: "المصادقة مطلوبة. عيّن OMNIROUTE_API_KEY أو شغّل: freeroute setup",
    ...
    program: {
      description: "FreeRoute — جهاز توجيه الذكاء الاصطناعي مع التبديل التلقائي",
      ...
      api_key: "مفتاح API لخادم FreeRoute",
      base_url: "عنوان URL الأساسي لخادم FreeRoute",
  ...
  az: {
    common: {
      error: "Xəta: {message}",
      serverOffline: "FreeRoute serveri oflayndır. Başladın: freeroute serve",
      authRequired:
        "Autentifikasiya tələb olunur. OMNIROUTE_API_KEY təyin edin və ya işə salın: freeroute setup",
    ...
    program: {
      description: "FreeRoute — Avtomatik Fallback ilə Ağıllı AI Marşrutlaşdırıcısı",
      ...
      api_key: "FreeRoute serveri üçün API açarı",
      base_url: "FreeRoute server baza URL-i",
  ...
  bg: {
    common: {
      ...
      serverOffline: "Сървърът FreeRoute е офлайн. Стартирайте с: freeroute serve",
      authRequired:
        "Необходима е автентикация. Задайте OMNIROUTE_API_KEY или изпълнете: freeroute setup",
    ...
    program: {
      description: "FreeRoute — Интелигентен AI рутер с автоматично превключване",
      ...
      api_key: "API ключ за сървъра FreeRoute",
      base_url: "Базов URL на сървъра FreeRoute",
  ...
  cs: {
    common: {
      error: "Chyba: {message}",
      serverOffline: "Server FreeRoute je offline. Spusťte: freeroute serve",
      authRequired: "Vyžaduje se ověření. Nastavte OMNIROUTE_API_KEY nebo spusťte: freeroute setup",
    ...
    program: {
      description: "FreeRoute — Chytrý AI router s automatickým přepínáním",
      ...
      api_key: "API klíč pro server FreeRoute",
      base_url: "Základní URL serveru FreeRoute",
  ...
  da: {
    common: {
      error: "Fejl: {message}",
      serverOffline: "FreeRoute-serveren er offline. Start med: freeroute serve",
      authRequired: "Godkendelse kræves. Sæt OMNIROUTE_API_KEY eller kør: freeroute setup",
    ...
    program: {
      description: "FreeRoute — Smart AI-router med automatisk fallback",
      ...
      api_key: "API-nøgle til FreeRoute-serveren",
      base_url: "FreeRoute-serverens basis-URL",
  ...
  de: {
    common: {
      ...
      serverOffline: "FreeRoute-Server ist offline. Starten mit: freeroute serve",
      authRequired:
        "Authentifizierung erforderlich. OMNIROUTE_API_KEY setzen oder ausführen: freeroute setup",
    ...
    program: {
      description: "FreeRoute — Intelligenter AI-Router mit automatischem Fallback",
      ...
      api_key: "API-Schlüssel für den FreeRoute-Server",
      base_url: "FreeRoute-Server-Basis-URL",
  ...
  es: {
    common: {
      error: "Error: {message}",
      serverOffline: "El servidor FreeRoute está offline. Inícielo con: freeroute serve",
      authRequired:
        "Autenticación requerida. Configure OMNIROUTE_API_KEY o ejecute: freeroute setup",
    ...
    program: {
      description: "FreeRoute — Router de IA inteligente con fallback automático",
      ...
      api_key: "Clave de API para el servidor FreeRoute",
      base_url: "URL base del servidor FreeRoute",
  ...
  fa: {
    common: {
      error: "خطا: {message}",
      serverOffline: "سرور FreeRoute آفلاین است. با این دستور راه‌اندازی کنید: freeroute serve",
      authRequired:
        "احراز هویت لازم است. OMNIROUTE_API_KEY را تنظیم کنید یا اجرا کنید: freeroute setup",
    ...
    program: {
      description: "FreeRoute — روتر هوشمند هوش مصنوعی با fallback خودکار",
      ...
      api_key: "کلید API برای سرور FreeRoute",
      base_url: "URL پایه سرور FreeRoute",
    ...
    common: {
      error: "Virhe: {message}",
      serverOffline: "FreeRoute-palvelin on offline. Käynnistä komennolla: freeroute serve",
      authRequired: "Todennus vaaditaan. Aseta OMNIROUTE_API_KEY tai suorita: freeroute setup",
    ...
    program: {
      description: "FreeRoute — Älykäs AI-reititin automaattisella fallbackilla",
      ...
      api_key: "API-avain FreeRoute-palvelimelle",
      base_url: "FreeRoute-palvelimen perus-URL",
  ...
  fr: {
    common: {
      ...
      serverOffline: "Le serveur FreeRoute est hors ligne. Démarrez avec : freeroute serve",
      authRequired:
        "Authentification requise. Définissez OMNIROUTE_API_KEY ou exécutez : freeroute setup",
    ...
    program: {
      description: "FreeRoute — Routeur IA intelligent avec basculement automatique",
      ...
      api_key: "Clé API pour le serveur FreeRoute",
      base_url: "URL de base du serveur FreeRoute",
  ...
  hi: {
    common: {
      ...
      serverOffline: "FreeRoute सर्वर ऑफलाइन है। शुरू करें: freeroute serve",
      authRequired: "प्रमाणीकरण आवश्यक है। OMNIROUTE_API_KEY सेट करें या चलाएं: freeroute setup",
    ...
    program: {
      description: "FreeRoute — ऑटो फॉलबैक के साथ स्मार्ट AI राउटर",
      ...
      api_key: "FreeRoute सर्वर के लिए API कुंजी",
      base_url: "FreeRoute सर्वर का बेस URL",
  ...
  hu: {
    common: {
      error: "Hiba: {message}",
      serverOffline: "Az FreeRoute szerver offline. Indítsa el: freeroute serve",
      authRequired:
        "Hitelesítés szükséges. Állítsa be az OMNIROUTE_API_KEY-t vagy futtassa: freeroute setup",
    ...
    program: {
      description: "FreeRoute — Intelligens AI útválasztó automatikus fallbackkel",
      ...
      api_key: "API kulcs az FreeRoute szerverhez",
      base_url: "Az FreeRoute szerver alap URL-je",
  ...
  id: {
    common: {
      ...
      serverOffline: "Server FreeRoute sedang offline. Mulai dengan: freeroute serve",
      authRequired:
        "Autentikasi diperlukan. Setel OMNIROUTE_API_KEY atau jalankan: freeroute setup",
    ...
    program: {
      description: "FreeRoute — Router AI Cerdas dengan Fallback Otomatis",
      ...
      api_key: "Kunci API untuk server FreeRoute",
      base_url: "URL dasar server FreeRoute",
  ...
  it: {
    common: {
      ...
      serverOffline: "Il server FreeRoute è offline. Avviarlo con: freeroute serve",
      authRequired:
        "Autenticazione richiesta. Impostare OMNIROUTE_API_KEY o eseguire: freeroute setup",
    ...
    program: {
      description: "FreeRoute — Router AI intelligente con fallback automatico",
      ...
      api_key: "Chiave API per il server FreeRoute",
      base_url: "URL base del server FreeRoute",
  ...
  ja: {
    common: {
      error: "エラー: {message}",
      serverOffline: "FreeRouteサーバーはオフラインです。起動: freeroute serve",
      authRequired:
        "認証が必要です。OMNIROUTE_API_KEYを設定するか実行してください: freeroute setup",
    ...
    program: {
      description: "FreeRoute — 自動フォールバック付きスマートAIルーター",
      version: "バージョンを表示して終了",
      output: "出力形式 (table, json, jsonl, csv)",
      quiet: "重要でない出力を抑制",
      no_color: "カラー出力を無効化",
      timeout: "HTTPリクエストタイムアウト（ミリ秒）",
      api_key: "FreeRouteサーバーのAPIキー",
      base_url: "FreeRouteサーバーのベースURL",
  ...
  ko: {
    common: {
      error: "오류: {message}",
      serverOffline: "FreeRoute 서버가 오프라인입니다. 시작: freeroute serve",
      authRequired: "인증이 필요합니다. OMNIROUTE_API_KEY를 설정하거나 실행하세요: freeroute setup",
    ...
    program: {
      description: "FreeRoute — 자동 폴백 기능을 갖춘 스마트 AI 라우터",
      version: "버전 출력 후 종료",
      output: "출력 형식 (table, json, jsonl, csv)",
      quiet: "불필요한 출력 억제",
      no_color: "색상 출력 비활성화",
      timeout: "HTTP 요청 타임아웃(밀리초)",
      api_key: "FreeRoute 서버의 API 키",
      base_url: "FreeRoute 서버 기본 URL",
  ...
  nl: {
    common: {
      error: "Fout: {message}",
      serverOffline: "FreeRoute-server is offline. Start met: freeroute serve",
      authRequired: "Authenticatie vereist. Stel OMNIROUTE_API_KEY in of voer uit: freeroute setup",
    ...
    program: {
      description: "FreeRoute — Slimme AI-router met automatische fallback",
      ...
      api_key: "API-sleutel voor de FreeRoute-server",
      base_url: "Basis-URL van de FreeRoute-server",
  ...
  no: {
    common: {
      error: "Feil: {message}",
      serverOffline: "FreeRoute-serveren er offline. Start med: freeroute serve",
      authRequired: "Autentisering kreves. Angi OMNIROUTE_API_KEY eller kjør: freeroute setup",
    ...
    program: {
      description: "FreeRoute — Smart AI-ruter med automatisk fallback",
      ...
      api_key: "API-nøkkel for FreeRoute-serveren",
      base_url: "FreeRoute-serverens basis-URL",
  ...
  pl: {
    common: {
      error: "Błąd: {message}",
      serverOffline: "Serwer FreeRoute jest offline. Uruchom: freeroute serve",
      authRequired:
        "Wymagane uwierzytelnienie. Ustaw OMNIROUTE_API_KEY lub uruchom: freeroute setup",
    ...
    program: {
      description: "FreeRoute — Inteligentny router AI z automatycznym fallbackiem",
      ...
      api_key: "Klucz API dla serwera FreeRoute",
      base_url: "Bazowy URL serwera FreeRoute",
  ...
  pt: {
    common: {
      error: "Erro: {message}",
      serverOffline: "O servidor FreeRoute está offline. Inicie com: freeroute serve",
      authRequired: "Autenticação necessária. Defina OMNIROUTE_API_KEY ou execute: freeroute setup",
    ...
    program: {
      description: "FreeRoute — Router de IA inteligente com fallback automático",
      ...
      api_key: "Chave de API para o servidor FreeRoute",
      base_url: "URL base do servidor FreeRoute",
  ...
  ro: {
    common: {
      ...
      serverOffline: "Serverul FreeRoute este offline. Porniți cu: freeroute serve",
      authRequired: "Autentificare necesară. Setați OMNIROUTE_API_KEY sau rulați: freeroute setup",
    ...
    program: {
      description: "FreeRoute — Router AI inteligent cu fallback automat",
      ...
      api_key: "Cheie API pentru serverul FreeRoute",
      base_url: "URL de bază al serverului FreeRoute",
  ...
  ru: {
    common: {
      ...
      serverOffline: "Сервер FreeRoute отключён. Запустите: freeroute serve",
      authRequired:
        "Требуется аутентификация. Установите OMNIROUTE_API_KEY или выполните: freeroute setup",
    ...
    program: {
      description: "FreeRoute — Умный AI-маршрутизатор с автоматическим переключением",
      ...
      api_key: "API-ключ для сервера FreeRoute",
      base_url: "Базовый URL сервера FreeRoute",
  ...
  sk: {
    common: {
      error: "Chyba: {message}",
      serverOffline: "Server FreeRoute je offline. Spustite: freeroute serve",
      authRequired:
        "Vyžaduje sa overenie. Nastavte OMNIROUTE_API_KEY alebo spustite: freeroute setup",
    ...
    program: {
      description: "FreeRoute — Inteligentný AI router s automatickým prepínaním",
      ...
      api_key: "API kľúč pre server FreeRoute",
      base_url: "Základná URL servera FreeRoute",
  ...
  sv: {
    common: {
      error: "Fel: {message}",
      serverOffline: "FreeRoute-servern är offline. Starta med: freeroute serve",
      authRequired: "Autentisering krävs. Ange OMNIROUTE_API_KEY eller kör: freeroute setup",
    ...
    program: {
      ...
      api_key: "API-nyckel för FreeRoute-servern",
      base_url: "FreeRoute-serverns bas-URL",
  ...
  th: {
    common: {
      ...
      serverOffline: "เซิร์ฟเวอร์ FreeRoute ออฟไลน์ เริ่มด้วย: freeroute serve",
      authRequired: "ต้องการการยืนยันตัวตน ตั้งค่า OMNIROUTE_API_KEY หรือรัน: freeroute setup",
    ...
    program: {
      description: "FreeRoute — AI Router อัจฉริยะพร้อม Auto Fallback",
      ...
      api_key: "API Key สำหรับ FreeRoute server",
      base_url: "Base URL ของ FreeRoute server",
  ...
  tr: {
    common: {
      error: "Hata: {message}",
      serverOffline: "FreeRoute sunucusu çevrimdışı. Başlatın: freeroute serve",
      authRequired:
        "Kimlik doğrulama gerekli. OMNIROUTE_API_KEY ayarlayın veya çalıştırın: freeroute setup",
    ...
    program: {
      description: "FreeRoute — Otomatik Fallback ile Akıllı AI Yönlendirici",
      ...
      api_key: "FreeRoute sunucusu için API anahtarı",
      base_url: "FreeRoute sunucusu temel URL'si",
  ...
  "uk-UA": {
    common: {
      ...
      serverOffline: "Сервер FreeRoute відключено. Запустіть: freeroute serve",
      authRequired:
        "Потрібна автентифікація. Встановіть OMNIROUTE_API_KEY або виконайте: freeroute setup",
    ...
    program: {
      description: "FreeRoute — Розумний AI-маршрутизатор з автоматичним перемиканням",
      ...
      api_key: "API-ключ для сервера FreeRoute",
      base_url: "Базовий URL сервера FreeRoute",
  ...
  vi: {
    common: {
      error: "Lỗi: {message}",
      serverOffline: "Máy chủ FreeRoute đang offline. Khởi động với: freeroute serve",
      authRequired: "Cần xác thực. Đặt OMNIROUTE_API_KEY hoặc chạy: freeroute setup",
    ...
    program: {
      description: "FreeRoute — Bộ định tuyến AI thông minh với tự động chuyển đổi dự phòng",
      ...
      api_key: "Khóa API cho máy chủ FreeRoute",
      base_url: "URL cơ sở của máy chủ FreeRoute",
  ...
  "zh-CN": {
    common: {
      error: "错误：{message}",
      serverOffline: "FreeRoute 服务器已离线。请启动：freeroute serve",
      authRequired: "需要认证。请设置 OMNIROUTE_API_KEY 或运行：freeroute setup",
    ...
    program: {
      description: "FreeRoute — 具有自动故障转移的智能 AI 路由器",
      version: "打印版本并退出",
      output: "输出格式（table, json, jsonl, csv）",
      quiet: "禁止非必要输出",
      no_color: "禁用彩色输出",
      timeout: "HTTP 请求超时（毫秒）",
      api_key: "FreeRoute 服务器的 API 密钥",
      base_url: "FreeRoute 服务器的基础 URL",
