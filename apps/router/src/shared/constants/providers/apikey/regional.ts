...
export const APIKEY_PROVIDERS_REGIONAL = {
  ...
  "ant-ling": {
    ...
    authHint:
      "Register and create an API key at the Ant Ling API console (https://chat.ant-ling.com/open), then paste it here. FreeRoute routes chat traffic to https://api.ant-ling.com/v1/chat/completions; the provider is OpenAI-compatible and also exposes an Anthropic-compatible surface.",
  },
  sarvam: {
    id: "sarvam",
    serviceKinds: ["llm"],
    ...
    apiHint:
      "Sarvam AI is OpenAI-compatible on /v1. FreeRoute probes /v1/models and routes chat traffic to /v1/chat/completions. Models are tuned for Indic languages.",
    hasFree: true,
