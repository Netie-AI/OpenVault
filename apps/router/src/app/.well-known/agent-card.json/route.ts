 ...
 *
 * Serves the FreeRoute A2A Agent Card in the A2A Protocol v1.0 shape for
 ...
 *
 * Returns the FreeRoute Agent Card (A2A v1.0).
 */
  ...
  const agentCard = {
    ...
    skills: [
      ...
      },
      {
        ...
        description: "Returns the full catalog of FreeRoute agent skills.",
