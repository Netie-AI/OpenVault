...
// Check if FreeRoute is configured as OpenAI-compatible provider
...
// POST - Configure Cline to use FreeRoute as OpenAI-compatible provider
...
// DELETE - Remove FreeRoute OpenAI-compatible provider config
export async function DELETE(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      message: "FreeRoute settings removed from Cline",
    });
  } catch (error) {
