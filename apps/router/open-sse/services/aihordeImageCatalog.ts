...
export const AI_HORDE_CLIENT_AGENT = "FreeRoute:3.8.51:https://github.com/Netie-AI/Netie";
export const AI_HORDE_CATALOG_POLL_MS = 30_000;
// The catalog endpoint is a fixed, trusted FreeRoute-controlled URL (not
