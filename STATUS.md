...
(#53 squash-merged). VPC allowlist for `POST /keys/services` (loopback +
`OPENVAULT_SERVICES_ALLOW`). JWKS pin kids (#50). No public `:5000`.
...
**UI:** `:3010` Compiling-proxy hang. Desktop: `openvault app`.
