"""Persist user's chosen *model slot* preferences (not architecture presets).

Architecture preset (DAG / LangGraph / minimal / …) lives in Cortex — see
PRODUCT_ROLES.md. This file only stores primary/fallback model + engine_id.
"""
