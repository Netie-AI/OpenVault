...
def catalog_coverage_report(vault_provider_ids: set[str] | frozenset[str]) -> dict[str, Any]:
    ...
    return {
        ...
        "omniroute_absorb_notes": (
            "Patterns absorbed: 4-tier fallback, free-tier surface, register links, "
            "downtime probes, circuit breaker. Not cloned: 250-provider matrix, "
            "compression engines, quota-share DRR."
        ),
        "similar_routers": [
            ...
            {"id": "omniroute", "why": "auto-fallback + free tier aggregation inspiration"},
        ],
    }
