...
| Skills library / distill ingest / Cortex crew | Not this repo. Cortex owns the skill registry and crew loop; Netie KB owns distilled reviews; OpenVault stays signpost + gate. Unlock: founder accepts [`DR-0012`](docs/decisions/DR-0012-skills-kb-crew-wiring.md) and the PRD agent routes Cortex + Netie-KB work. Building `/api/skills` here without that amendment is the third orchestrator. |
